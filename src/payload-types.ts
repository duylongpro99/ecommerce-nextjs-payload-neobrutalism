...
export interface Tenant {
  ...
  /**
   * Please submi Payment details before create products
   */
...
export interface Order {
   ...
   */
  paymentCheckoutSesstionId: string;
